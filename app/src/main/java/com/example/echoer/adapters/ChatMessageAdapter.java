...
public class ChatMessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == Constants.VIEW_TYPE_SENT) {
            ((SentMassageViewHolder) holder).setData(chatMessage);
            ...
            ((ReceivedMassageViewHolder) holder).setData(chatMessage);
            // 同样的逻辑适用于接收的消息
            // ...
        }
    }
    ...
    static class SentMassageViewHolder extends RecyclerView.ViewHolder {
        ...
        SentMassageViewHolder(ItemContainerSentMessageBinding binding) {
